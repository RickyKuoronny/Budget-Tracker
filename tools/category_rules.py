CATEGORY_RULES = {
    ...
    'Groceries': [
        ...
        'FRUIT', 'GREENGROCER', 'BUTCHER', 'SEAFOOD', 'ASIAN GROCER',
        'FRESH FOOD', 'SUNLIT', 'PLUSMART', 'GENKI MART',
    ],
    ...
    'Food & Dining': [
        ...
        'MASSIMO', 'JIUBO', 'TIANXIA', 'COCOART', 'AMFOODS',
        ...
        'BNE BROTHERS', 'CLOVERAUS', 'OTBO', 'SUNSHINE',
        'HAEDURI', 'EATCLUB', 'ADDICTEA', 'HEERETEA', 'HEYTEA',
        'KAIKAI', 'SLIMS', '2 BROS', 'GOUKARI', 'AUTHENTIC',
        'BREWER', 'COFFE',
    ],

    'Transport': [
        'TRANSLINK', 'PARKING', 'CAR PARK', 'CELLOPARK',
        'UNITED', 'PETROL', 'AMPOL', 'SHELL',
