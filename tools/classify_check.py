...
CATEGORY_RULES = {
    ...
    'Reimbursements': [
        ...
        'PAYBACK', 'REPAY', 'OSKO PAYMENT FROM', 'OSKO PAYMENT TO', 'TAX', 'BEEM'
    ],
    ...
    'Food & Dining': [
        'RESTAURANT', 'CAFE', 'NANDOS', '2 BROS', 'COFFEE', 'ESPRESSO', 'BAKERY', 'FOOD COURT',
        'RAMEN', 'SUSHI', 'KOREAN', 'JAPANESE', 'CHICKEN', 'BURGER', 'PIZZA', 'KEBAB', "WIL'S RESTO",
        ...
        'KIN TENERIFFE', 'ZAM', 'MILKI', 'A YI', 'K WANT EAT', 'MR DENO', 'TARTE', 'FALALALAH', 'U GO',
        'GELATO', 'MESSINA', 'ACAI', 'GRIDDLE', 'KATSU', 'LUCKY BOWL',
        'UDONYA', 'ODAYA', 'KUAFOOD', 'MY STREET FOOD', 'UNCLE DON',
        'KINGWU', 'BARRY UNION', 'MENAGERIE', 'MEKONG', 'STARBUCKS',
        'PKATSU', 'IKKAKU', 'MALAYACNR', 'MALAYA CORN', 'NOA EVEN',
        'FOOD EMPEROR', 'K GARDEN', 'WIL S RESTO', 'SAINT LUCY CAFFE',
        '5 BOROUGHS', 'BIG KID ICE', 'NONOS', 'INSANE ACAI', 'ANITA GELATO',
        'BEING RICHBRO', 'MISS CLAUDES', 'ALLORA',
        'KIN TENERIFFE', 
        'ZAM', 'MILKI', 'A YI', 'K WANT EAT', 'FALALALAH',
        'CYD HOLDING',  
        'BNE BROTHERS', 'CLOVERAUS', 'OTBO'
    ],
    ...
    'Shopping': ['KMART', 'BIG W', 'UNIQLO', 'DAVID JONES', 'OFFICEWORKS', 'JB HI FI', 'REBEL', 'SPOTLIGHT', 'JAYCAR', 'FLOWER', 
                 'FLOWERS', 'FLORIST', 'UNIVERSITY', 'QUT', 'COURSE', 'TEXTBOOK', 'UDEMY', 'COURSERA', 'REJECT', 'CAMBRIDGE', 
                 'DUSK', 'KOORONG', 'MADEINEARTH', 'CLOTHING', 'DAVIDJONESL', 'STACKS VARIETY', 
                 'NOVO SHOES', 'IKEA', 'EBAY', 'PETSTOCK',
                 'DOLLARS AND SENSE', 'W RETAIL GROUP', 'STACKS VARIETY',
    ],

    'Entertainment': ['RIOT GAMES', 'SUPERCELL', 'STEAM', 'EB GAMES', 'POKEMON', 'XSOLLA', 'RIOTGAMESLI'],

    'Travel': ['AIRBNB', 'BOOKING', 'KLOOK', 'AUNT BETTY', 'SMARTE CARTE', 'STATION', 'TURO',
               'AUNTBETTY', 'TRAVELKON'
    ],
